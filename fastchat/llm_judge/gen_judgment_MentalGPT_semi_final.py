...
def make_judge_single(judge_model, judge_prompts):
    judges = {}
    judges["default"] = Judge(judge_model, judge_prompts["single-mental-v1"])
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="C:/Users/Meimi/Desktop/FastChat_gemini/fastchat/llm_judge/data/judge_prompts.jsonl",
        help="The file of judge prompts.",
    )
    parser.add_argument(
        "--out-name",
        type=str,
        default="model_judgment",
        help="The name of the output file.",
    )
    parser.add_argument("--judge-model", type=str, default="gpt-4-1106-preview") #gpt-4-1106-preview
    ...
    question_file = f"C:/Users/Meimi/Desktop/FastChat_gemini/fastchat/llm_judge/data/{args.bench_name}/question.jsonl"
    answer_dir = f"C:/Users/Meimi/Desktop/FastChat_gemini/fastchat/llm_judge/data/{args.bench_name}/neurips_model_answer"
    ref_answer_dir = f"C:/Users/Meimi/Desktop/FastChat_gemini/fastchat/llm_judge/data/{args.bench_name}/reference_answer"
    ...
    if args.mode == "single":
        ...
        output_file = (
            ...
            f"C:/Users/Meimi/Desktop/FastChat_gemini/fastchat/llm_judge/data/{args.bench_name}/neurips_model_judgment_gemini/{args.judge_model}_{args.out_name}.jsonl"
        )
        ...
        output_file = (
            ...
            f"C:/Users/Meimi/Desktop/FastChat_gemini/fastchat/llm_judge/data/{args.bench_name}/model_judgment/{args.judge_model}_pair.jsonl"
        )
